...
public interface Page_Element {
	...
	// By = By.xpath();
	     ...
	     By tabledropdown = By.xpath("(//img[@alt='tableInActive'])[2]");
	     By guidelines = By.xpath("//a[@routerlink='/guidelines']");
	     By addguidelines = By.xpath("//button[text()='+']");
	     By addconsumerprompt = By.xpath("(//img[@alt='file upload'])[3]");
	     By removeconsumerprompt = By.xpath("(//img[@alt='file upload'])[4]");
